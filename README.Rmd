...
You can install the development version of SCA from [GitHub](https://github.com/) with:
...
![image](https://github.com/UMC-Utrecht-RWE/SCA/assets/138911044/8cbb1033-3e7b-4a05-9c0f-904e55f9fea3)
...
The function `wrangle_window()` takes as input a wide-format dataset following the same format as that created by `compute_windows(..., output_format = "wide")`. In addition, the function takes the names of different date columns in the input dataset which are used for censoring. 
