test_that("scri returns analysis table with expected core fields", {
  ...
  study_population <- data.table::data.table(
    ...
    covid_vaccine_1 = as.Date(c("2021-01-05", "2023-04-05", "2022-01-05", "2021-09-05", "2022-09-05")),
    covid_vaccine_2 = as.Date(c("2022-01-05", "2024-04-05", NA, NA, NA)),
...
test_that("scri saves all intermediate outputs when save_intermediate is provided", {
  ...
  study_population <- data.table::data.table(
    ...
    covid_vaccine_1 = as.Date(c("2021-01-05", "2023-04-05")),
    covid_vaccine_2 = as.Date(c("2022-01-05", "2024-04-05")),
