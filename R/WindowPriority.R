...
#'
#' @format ## `WindowsPriority`
#' A data frame with rows defining priority rules:
#' \describe{
#'   \item{outcome}{Outcome identifier matching those in WindowsMetadata (chr)}
...
#'
#' @seealso [WindowsMetadata] for window definitions, [construct_windows()] for window computation, [wrangle_window()] for applying priority rules.
"WindowsPriority"
