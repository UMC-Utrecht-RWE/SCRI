...
#' @param reference_date_name Character vector of column names to be renamed
...
#' study_data <- data.table(id = 1:3, index_date = as.Date(c("2023-01-01", "2023-02-15", "2023-03-10")))
...
#' renamed_data <- rename_anchor(study_data, c("index_date", "cohort_entry"), prefix_name = "ref_")
#' }
#'
#' @importFrom data.table setnames
#' @keywords internal
#' 
rename_anchor <- function(study_population, reference_date_name, prefix_name = 'anch_') {
