...
with purple boxes representing functions of the package, blue boxes
...
`wrangle_window()` function. Inspecting the output we can see that
...
- `scri_trimmed`: The input data object recording start/end dates of
  ...
  long format, output of wrangle_window
